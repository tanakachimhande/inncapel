    ...
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center h-100">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 700px">
                    <table class="table table-striped mb-0 table-bordered" >
                      ...
                      <tbody>
                        @foreach ($whyusContent as $content )
                        <tr class="text-center">
                            <td>{{$content->title}}</td>
                            <td>{{$content->description}}</td>
                            <td>
                            <a href="{{route('edit-whyus',['id'=>$content->id])}}"  class='btn btn-sm btn-success'>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('delete-whyus',['id'=>$content->id])}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('store-whyus-content')}}">
                @csrf
                <div class="mb-3">
