...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <div class="container-fluid">
        <h4 style="color: #3498db">PROJECTS SECTION</h4>
      <hr>
      <a href="#" type="button" class="btn btn-success btn-lg px-4 me-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Project</a>
      <hr>
      <div class="d-flex align-items-center h-100">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('store-project-content')}}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="message-text" class="col-form-label">Project Image:</label>
                    <input type="file" class="form-control" id="recipient-name" name="project_image_path" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="recipient-name" name="project_url" required>
                </div>
                <div class="modal-footer">
