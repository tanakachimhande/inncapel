         ...
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-contact')}}"  method="post">
                ...
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$contact->address}}' name="address" />
                    <label class="form-label" for="form12">Address:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$contact->phone}}' name="phone" />
                    <label class="form-label" for="form12">Phone:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$contact->email}}' name="email" />
                    <label class="form-label" for="form12">Email:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$contact->opening_days}}' name="opening_days" />
                    <label class="form-label" for="form12">Opening Days:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$contact->opening_hours}}' name="opening_hours" />
                    <label class="form-label" for="form12">Opening Hours:</label>
                </div>
                 <br>
