         ...
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-faq')}}"  method="post">
                ...
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$faq->question}}' name="question" />
                    <label class="form-label" for="form12">Question:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <textarea cols="30" rows="5" id="form12" class="form-control form-control-lg" name="answer">{{$faq->answer}}</textarea>
                    <label class="form-label" for="form12">Answer:</label>
                </div><br>
