         ...
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-about')}}"  method="post">
                ...
                <div class="form-outline mb-3" data-mdb-input-init>
                    <textarea cols="30" rows="5" id="form12" class="form-control form-control-lg" name="description">{{$about->description}}</textarea>
                    <label class="form-label" for="form12">About Description</label>
                </div><br>
