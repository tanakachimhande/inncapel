    ...
    <div class="container-fluid">
      ...
      <hr>
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-subservice')}}"  method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$subservice->service_name}}' name="service_name" />
                    <label class="form-label" for="form12">Service Name:</label>
                </div>
                 <br>
