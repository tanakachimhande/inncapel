    ...
    <div class="container-fluid">
      ...
      <hr>
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-testy')}}"  method="post">
                @csrf
                <input type="hidden" name="id" value="{{$testy->id}}">
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$testy->name}}' name="name" />
                    <label class="form-label" for="form12">Client Name</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$testy->business}}' name="business" />
                    <label class="form-label" for="form12">Client Business</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <textarea cols="30" rows="5" id="form12" class="form-control form-control-lg" name="description">{{$testy->description}}</textarea>
                    <label class="form-label" for="form12">Testimony</label>
                </div><br>
