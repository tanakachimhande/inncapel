         ...
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-service')}}"  method="post" enctype="multipart/form-data">
                ...
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$service->services_title}}' name="services_title" />
                    <label class="form-label" for="form12">Category Name:</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="file" id="form12" class="form-control form-control-lg" value='{{$service->services_image_path}}' name="service_image_path" />
                </div>
                 <br>
