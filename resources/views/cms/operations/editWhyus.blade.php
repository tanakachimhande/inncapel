    ...
    <div class="container-fluid">
      ...
      <hr>
         <div class="container bg-white p-5">
            ...
            <form action="{{route('update-whyus')}}"  method="post">
                @csrf
                <input type="hidden" name="id" value="{{$whyus->id}}">
                <div class="form-outline mb-3" data-mdb-input-init>
                    <input type="text" id="form12" class="form-control form-control-lg" value='{{$whyus->title}}' name="title" />
                    <label class="form-label" for="form12">Title</label>
                </div>
                <div class="form-outline mb-3" data-mdb-input-init>
                    <textarea cols="30" rows="5" id="form12" class="form-control form-control-lg" name="description">{{$whyus->description}}</textarea>
