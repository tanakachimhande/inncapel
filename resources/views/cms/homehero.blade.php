...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <div class="container-fluid">
        <h4 style="color: #3498db">HERO SECTION</h4>
      <hr>
      <a href="#" type="button" class="btn btn-success btn-lg px-4 me-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Hero Content</a>
      <hr>
      <div class="d-flex align-items-center h-100">
                    ...
                    <table class="table table-striped mb-0 table-bordered" >
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                             <a href="{{route('edit-hero',['id'=>$content->id])}}"  class='btn btn-sm btn-success'>
                                 <i class='fa fa-edit fa-x2'></i>
                             </a>
                             <a href="javscript(0)" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteConfirmationModal{{$content->id}}"><i class='fa fa-trash fa-x2'></i></a>
                           </td>
                        </tr>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('delete-hero',['id'=>$content->id])}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('store-hero-content')}}">
                @csrf
