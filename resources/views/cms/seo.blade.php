...
<div class="page-wrapper chiller-theme toggled">
  ...
  <main class="page-content">
    <div class="container-fluid">
        <h4 style="color: #3498db">SEO DATA</h4>
      <hr>
      <a href="#" type="button" class="btn btn-success btn-lg px-4 me-md-2" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">Add Data</a>
      <hr>
      <div class="d-flex align-items-center h-100">
                  ...
                  <div class="table-responsive table-scroll" data-mdb-perfect-scrollbar="true" style="position: relative; height: 700px">
                    <table class="table table-striped mb-0 table-bordered" >
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                            <td>{{$content->seo_page}}</td>
                            <td>{{$content->seo_title}}</td>
                            <td>{{$content->seo_description}}</td>
                            <td>{{$content->seo_keywords}}</td>
                            <td>
                            <a href="{{route('edit-seo-data',['id'=>$content->id])}}"  class='btn btn-sm btn-success'>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('delete-seo-data',['id'=>$content->id])}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add SEO</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form method="post" action="{{route('store-seo-data')}}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                    <label for="message-text" class="col-form-label">SEO Page:</label>
                    <input type="text" class="form-control" id="recipient-name" name="seo_page" required>
                </div>
                <div class="mb-3">
