    ...
    <div class="container-fluid">
      ...
      <div class="d-flex align-items-center h-100">
                    ...
                    <table class="table table-striped mb-0 table-bordered" >
                      ...
                      <tbody>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                            <a href="{{route('edit-testy',['id'=>$content->id])}}"  class='btn btn-sm btn-success'>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('delete-testy',['id'=>$content->id])}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('store-testimonials-content')}}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="recipient-name" name="business" required>
                </div>
                <div class="mb-3">
