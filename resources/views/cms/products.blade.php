                      ...
                      <tbody>
                       ...
                       @foreach ($products as $content )
                        <tr class="text-center">
                            ...
                            <td>{{$content->product_link}}</td>
                            <td>
                            <a href="{{route('edit-product',['id'=>$content->id])}}"  class='btn btn-sm btn-success'>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="{{route('delete-product',['id'=>$content->id])}}" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                        </div>
